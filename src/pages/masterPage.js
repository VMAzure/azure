// Il codice di questo file si caricherà su tutte le pagine del sito
...
*/
export function footer1_click(event) {
...
*	 @param {$w.MouseEvent} event
*/
export function footer1_dblClick(event) {
	// This function was added from the Properties & Events panel. To learn more, visit http://wix.to/UcBnC-4
	// Add your code for this event here: 
}
...
*	 @param {$w.MouseEvent} event
*/
export function footer1_mouseOut(event) {
	// This function was added from the Properties & Events panel. To learn more, visit http://wix.to/UcBnC-4
	// Add your code for this event here: 
}
...
*	 @param {$w.MouseEvent} event
*/
export function footer1_mouseIn(event) {
	// This function was added from the Properties & Events panel. To learn more, visit http://wix.to/UcBnC-4
	// Add your code for this event here: 
}